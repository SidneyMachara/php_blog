...
if(isset($_POST['offset']) && isset($_POST['limit']) && isset($_POST['category'])){

      $limit = $_POST['limit'];
      $offset = $_POST['offset'];
      $categoryID = $_POST['category'];

      $query = "SELECT * FROM posts WHERE category = '$categoryID' ORDER BY date_published DESC LIMIT {$limit} OFFSET {$offset}";
