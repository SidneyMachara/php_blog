...
if(isset($_POST['offset']) && isset($_POST['limit']) && isset($_POST['searchQuery'])){
      ...
      $query = "SELECT * FROM posts where (title LIKE '%$searchQuery%') ORDER BY date_published DESC LIMIT {$limit} OFFSET {$offset}";
